...
var createNewBox = function createNewBox() {
  var box = new konva__WEBPACK_IMPORTED_MODULE_1___default.a.Rect({
    x: getRandomX(),
    y: getRandomY(),
    width: 100,
    height: 50,
...
var createNewWedge = function createNewWedge() {
  return new konva__WEBPACK_IMPORTED_MODULE_1___default.a.Wedge({
    x: getRandomX(),
    y: getRandomY(),
    radius: 50,
...
var getRandomRotation = function getRandomRotation() {
